...
import static com.luminus.labs.dynamicbob.activities.AppearanceActivity.IMAGE_PICK_CODE;
import static com.luminus.labs.dynamicbob.activities.AppearanceActivity.PERMISSION_REQUEST_CODE;
...
public class PermissionActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.notification_access).setOnClickListener(l -> {
            ...
            Toast.makeText(this, "Please select Dynamic Bob", Toast.LENGTH_LONG).show();
        });
