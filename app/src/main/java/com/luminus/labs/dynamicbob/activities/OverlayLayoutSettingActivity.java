...
public class OverlayLayoutSettingActivity extends AppCompatActivity {
    ...
    Slider h;
    TextView val_h;
    MaterialButton add_h;
    MaterialButton sub_h;

    Slider gap;
    TextView val_gap;
    MaterialButton add_gap;
    MaterialButton sub_gap;

    Slider x;
    TextView val_x;
    MaterialButton add_x;
    MaterialButton sub_x;

    Slider w;
    MaterialButton add_w;
    MaterialButton sub_w;

    Slider y;
    TextView val_y;
    MaterialButton add_y;
    MaterialButton sub_y;
